...
function elite_scripts() {
	...
	wp_enqueue_script( 'elite-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
		...
		wp_enqueue_script( 'elite-navigation', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '20151215', true );
			wp_enqueue_script( 'elite-navigation', get_template_directory_uri() . '/js/customizer.js', array(), '20151215', true );
